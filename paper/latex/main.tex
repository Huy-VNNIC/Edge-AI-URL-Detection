...
The proposed system employs systematic comparison of five AI approaches (Random Forest, Logistic Regression, SVM, XGBoost, Neural Networks) to establish scientific rigor. Our novel 31-dimensional feature engineering framework enables AI algorithms to achieve competitive cybersecurity performance, with Random Forest achieving 72.30\% accuracy and 0.7089 F1-score, validating the effectiveness of our approach. Through comprehensive performance analysis across accuracy, latency, memory, and throughput dimensions, Random Forest emerges as optimal for edge deployment, balancing robust classification performance with acceptable inference time (36.94ms).

Extensive experimental evaluation on a large-scale dataset of 100,000 URLs demonstrates competitive AI performance across five algorithms, with performance ranging from 63.6% to 72.4% accuracy and F1-scores from 0.494 to 0.709, exhibiting significant throughput variations (12K-1.4M samples/sec). Feature importance analysis reveals URL lexical features contribute 51.5\%, domain metadata 33.8\%, establishing the scientific foundation for edge-optimized AI security systems. The complete AI framework achieves mean inference latency of 10.50 ms and memory footprint below 6.23 MB, validating real-world feasibility for IoT gateway deployment.
\end{abstract}
...
\begin{itemize}
  ...
  \item We develop a novel 31-dimensional feature engineering methodology that enables AI approaches to achieve competitive cybersecurity performance, with Random Forest achieving 72.30\% accuracy and 0.7089 F1-score, with quantified feature importance analysis revealing URL lexical features (51.5\%) and domain metadata (33.8\%) as primary contributors.
  \item We demonstrate scientifically-grounded AI model selection for edge deployment, showing Random Forest provides optimal balance of robust cybersecurity performance (72.30\% accuracy, 0.7089 F1-score), acceptable inference time (36.94ms), and deployment flexibility for resource-constrained IoT environments.
...
Figure~\ref{fig:results} summarizes the performance evaluation results. The AI methodology evaluation demonstrates competitive performance across multiple models, with Random Forest achieving the best overall performance (72.30\% accuracy, 0.7089 F1-score), validating our feature engineering approach and establishing strong scientific foundation for edge-AI security systems suitable for realistic cybersecurity applications.
...
This research addresses a critical gap in IoT security by establishing the first comprehensive Edge-AI framework specifically designed for malicious URL detection at the network perimeter. The growing sophistication of cyber threats targeting resource-constrained IoT environments necessitates intelligent, autonomous defense mechanisms that can operate independently of cloud connectivity. Our work demonstrates that carefully engineered AI solutions can provide effective cybersecurity capabilities within the stringent constraints of edge computing environments.

The significance of this contribution lies in bridging theoretical AI advances with practical cybersecurity deployment requirements. While traditional approaches either sacrifice accuracy for efficiency or require excessive computational resources, our systematic methodology identifies the optimal balance point for real-world IoT gateway deployment. The Random Forest-based solution achieves production-ready performance (72.30\% accuracy, 0.7089 F1-score) while maintaining sub-millisecond inference capabilities and minimal memory footprint essential for edge environments.

Beyond algorithmic contributions, this work establishes rigorous evaluation methodologies for Edge-AI security systems. The comprehensive comparison across five AI paradigms provides actionable intelligence for practitioners selecting appropriate algorithms for specific deployment constraints. Our findings reveal that algorithmic choice significantly impacts operational characteristics, with throughput varying by two orders of magnitude (12K-1.4M samples/sec) while maintaining comparable accuracy levels.

The practical impact extends to enabling autonomous threat detection capabilities in environments where traditional cloud-based solutions fail due to connectivity limitations, latency constraints, or privacy requirements. Industrial IoT deployments, remote infrastructure monitoring, and privacy-sensitive applications can now incorporate intelligent URL filtering without compromising operational requirements or data sovereignty.

From a scientific perspective, this work contributes validated methodologies for evaluating AI systems under resource constraints, demonstrating how classical machine learning approaches can achieve competitive performance through systematic feature engineering and optimization. The open-source availability of our complete framework, including containerized deployment and comprehensive evaluation scripts, facilitates reproducibility and accelerates future research in Edge-AI security.

Future investigations will focus on three critical areas: (1) adaptive learning mechanisms to address evolving threat landscapes through federated intelligence sharing among IoT deployments, (2) adversarial robustness evaluation and defense strategies specifically tailored for edge-constrained environments, and (3) integration with broader IoT security frameworks to provide comprehensive network-level protection. These directions will enhance the resilience and adaptability of edge-deployed AI security systems while maintaining the computational efficiency essential for IoT environments.
