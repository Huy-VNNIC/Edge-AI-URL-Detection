...
\item \textbf{Real-time Processing}: Model prediction time of **7.31 ms** enables real-time URL analysis suitable for IoT gateway environments.
\end{enumerate}
...
The key AI innovations include: (1) **Feature engineering framework** that enables multiple AI paradigms to reach **realistic cybersecurity performance levels (70-72% accuracy range)**, (2) **Systematic AI model comparison** providing **empirical** selection guidelines for edge deployment, (3) **Quantified performance trade-off analysis** revealing **112-408 samples/sec model-only throughput variations** critical for deployment decisions, and (4) **Resource-aware AI optimization** demonstrating how classical models can outperform complex approaches in constrained environments.
